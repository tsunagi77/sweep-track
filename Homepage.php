...
<div class="sidebar" id="sidebar">
  <button id="homeBtn" class="active" onclick="setActive(this, 'Homepage.php')">
...
<main class="content">
  <div class="head">
    ...
    <br>
    <p>This is the MMDA Pateros Sweep Track System. Thank you for your hard work in keeping our streets clean and safe for everyone. Your dedication is truly appreciated. Remember to take breaks, stay hydrated, and prioritize your health as you go about your tasks today. Have a productive and safe day ahead!</p>
  </div>
  <div class="top"> Metropolitan Manila Development Authority: Sweepers</div>
  <div class="announcement">
        <div class="top" style="margin-bottom: 0px;"><i>Announcement</i></div>
          <div id="announcement-container" style="background-color: #f1f2f6;">
      </div>
  </div>

<script>
    fetch('getAnnounce.php')
        ...
        .then(data => {
            if (data.success && data.imagePath) {
                ...
                document.getElementById('announcement-container').appendChild(img);
            } else {
                document.getElementById('announcement-container').innerText = "No announcement yet.";
            }
        })
