...
$sql = "
    ...
    FROM 
        Docs d
    INNER JOIN 
        sweepers s ON d.employeeID = s.employeeID
    ORDER BY 
        d.upload_date DESC, s.name ASC";
...
<div class="sidebar" id="sidebar">
  ...
  <button id="feedbackBtn" onclick="setActive(this, 'supervisorForm.php')">
...
<div class="rec" style="height: 100vh;">
    <div class="record">
    <h1 style="display: inline; color:black;">Uploaded Files</h1>
    <button onclick="goBack()">Back to Documentation</button>
    <table border="1" style="background-color: #f1f2f6;">
            <?php
            if ($result->num_rows > 0) {
                echo "<table border='1' cellpadding='10' style='background-color: #f1f2f6;'>
                    <tr>
                        ...
                        <th style='background-color: green; color: white;'>File Name</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td><a href='". htmlspecialchars($row['file_path']) . "' target='_blank'>" . basename($row['file_path']) . "</a></td>
