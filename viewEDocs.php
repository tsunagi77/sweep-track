...
$query = "
    SELECT d.*, s.name 
    FROM Docs d
    JOIN sweepers s ON d.employeeID = s.employeeID
...
<div class="rec" style="height: 100vh;">
    <div class="record">
    <h1 style="display: inline; color: black;">Uploaded Files</h2>
    <table border="1" style="background-color: #f1f2f6;">
        <thead>
            <tr>
                ...
                <th style="background-color: green; color: white;">Upload Time</th>
            </tr>
        </thead>
        <tbody>
            <?php
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='" . htmlspecialchars($row['file_path']) . "' target='_blank'>" . basename($row['file_path']) . "</a></td>";
